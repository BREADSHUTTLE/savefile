...
namespace CAPYBARA
{
    ...
    {
        public static class SPoker
        {
            /// spoker서버 연결시 받는 홀덤서버 고유 id값
            ...
            public static SPokerState currentSPokerState;
            
            
            
            //방 입장시 콜백
            public static Action<sevenPoker.EnterRes> EnterRoom;
            ...
            public static Func<SPokerPlayerController,bool,string> CardRecieved;
